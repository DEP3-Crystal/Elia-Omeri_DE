...
public class FuncProg2 {
    ...
    public static void main(String[] args) {
        ...
        //Because we haven't collect the information
        //we should add the following : .collect(Collectors.toList()); as above which collect all the information and save it as  a list
    }
}
